...
class MedNeXtDownBlock(MedNeXtBlock):
    ...
    def __init__(self, in_channels, out_channels, exp_r=4, kernel_size=7, stride=2,
        ...
        super().__init__(in_channels, out_channels, exp_r, kernel_size, stride=2,
...
class MedNeXtUpBlock(MedNeXtBlock):
    ...
    def forward(self, x, dummy_tensor=None):
        ...
        if self.dim == '2d' or self.pad_TF == True:
...
if __name__ == "__main__":
    network = MedNeXtBlock(in_channels=12, out_channels=12, do_res=True, grn=True, norm_type='group')

    with torch.no_grad():
        print(network)
        x = torch.zeros((2, 12, 64, 64, 64))
