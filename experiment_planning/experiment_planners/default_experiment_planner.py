...
class ExperimentPlanner(object):
    ...
    def plan_experiment(self):
        ...
        #fullres_spacing = np.array([3.0, 1.10546875, 1.10546875])
        #fullres_spacing = np.array([3.0, 0.6836, 0.6836]) 
        #fullres_spacing = np.array([1.0, 1.0, 1.0]) 
        ...
        if plan_3d_fullres is not None:
            ...
            plan_3d_fullres['num_pool_per_axis']=[2, 6, 6]
            plan_3d_fullres['patch_size']=[32, 256, 256]
            plan_3d_fullres['batch_size']=2
            plan_3d_fullres['n_conv_per_stage_encoder']=(2, 2, 2, 2, 2, 2, 2)
            plan_3d_fullres['n_conv_per_stage_decoder']=(2, 2, 2, 2, 2, 2)
            plan_3d_fullres['pool_op_kernel_sizes']=[[1, 1, 1],[1, 2, 2],[1, 2, 2],[2, 2, 2],[2, 2, 2],[1, 2, 2],[1, 2, 2]]
            plan_3d_fullres['conv_kernel_sizes']=[[1, 3, 3],[1, 3, 3],[3, 3, 3],[3, 3, 3],[3, 3, 3],[3, 3, 3],[3, 3, 3]]
